...
* Make sure you already have your own shared library published.
 with your own shared library.
* Rrun `npm install` command.
...
* Steps to build and push your image to docker hub
  * `docker build -t <your-dockerhub-username>/spepas-chat .`
  * `docker tag <your-dockerhub-username>/spepas-chat <your-dockerhub-username>/spepas-chat:stable`
  * `docker push <your-dockerhub-username>/spepas-chat:stable`
